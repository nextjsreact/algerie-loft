-- Script pour améliorer la capture d'utilisateur dans les audits
-- Exécutez ce script dans Supabase Dashboard > SQL Editor

-- =====================================================
-- 1. CRÉER UNE FONCTION POUR DÉFINIR LE CONTEXTE UTILISATEUR
-- =====================================================

-- Fonction pour définir l'utilisateur actuel dans le contexte de session
CREATE OR REPLACE FUNCTION audit.set_current_user_context(
    user_id UUID,
    user_email TEXT DEFAULT NULL
)
RETURNS VOID AS $$
BEGIN
    -- Définir l'utilisateur dans les variables de session
...
-- =====================================================
-- 2. AMÉLIORER LA FONCTION TRIGGER POUR UTILISER LE CONTEXTE
-- =====================================================
...
-- =====================================================
-- 3. FONCTION HELPER POUR DÉFINIR TOUTES LES INFOS CONTEXTUELLES
-- =====================================================
...
-- =====================================================
-- 4. FONCTION POUR NETTOYER LE CONTEXTE
-- =====================================================
...
INSERT INTO transactions (
    ...
    555.55,
    'Test avec contexte utilisateur',
    (SELECT unnest(enum_range(NULL::transaction_type)) LIMIT 1),
    'pending',
    NOW()
);
...
SET 
    amount = 777.77,
    description = 'Test avec contexte utilisateur - modifié'
WHERE description = 'Test avec contexte utilisateur';
...
-- Nettoyer le test
DELETE FROM transactions WHERE description = 'Test avec contexte utilisateur - modifié';
SELECT audit.clear_audit_context();

SELECT 'Amélioration du contexte utilisateur terminée!' as message;