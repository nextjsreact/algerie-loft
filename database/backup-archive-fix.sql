-- =====================================================
-- BACKUP AND ARCHIVE SYSTEM - INCREMENTAL FIX
-- =====================================================
...
-- =====================================================
-- CREATE RLS POLICIES (DROP FIRST IF EXIST)
-- =====================================================

-- Backup alerts policies
DROP POLICY IF EXISTS "backup_alerts_superuser_policy" ON backup_alerts;
...
DROP POLICY IF EXISTS "archive_policies_superuser_policy" ON archive_policies;
...
DROP POLICY IF EXISTS "archive_records_superuser_policy" ON archive_records;
CREATE POLICY "archive_records_superuser_policy" ON archive_records
    FOR ALL
    USING (can_manage_backups())
    WITH CHECK (can_manage_backups());

-- Archived data index policies
DROP POLICY IF EXISTS "archived_data_index_superuser_policy" ON archived_data_index;
