        ...
        <div className="flex justify-between items-center py-4">
          ...
          <div className={`hidden md:flex items-center ${locale === 'ar' ? 'space-x-reverse space-x-6 flex-row-reverse' : 'space-x-6'}`}>
            ...
            {isAuthenticated ? (
              ...
              <button 
                className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-4 py-2 rounded-lg font-semibold hover:from-blue-700 hover:to-purple-700 transition-all duration-300 flex items-center gap-2 text-base shadow-lg"
              >
                🔐 {text.login}
