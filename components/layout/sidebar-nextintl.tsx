...
export function Sidebar({ user, unreadCount, className }: SidebarProps) {
  ...
  const navTranslations = {
    fr: {
      ...
      announcements: "Annonces Urgentes",
    ...
    ar: {
      ...
      teams: "الفرق",
      owners: "الملاك",
      partners: "طلبات الشركاء",
      transactions: "المعاملات",
      reports: "التقارير",
      reportsNav: "التقارير",
      planning: "تخطيط الفريق",
      settings: "الإعدادات",
      logout: "تسجيل الخروج",
  ...
  const navigation = [
    ...
    { name: t('planning'), href: `/${locale}/planning`, icon: ClipboardList, roles: ["admin", "manager"] },
    { 
      name: t('settings'), 
