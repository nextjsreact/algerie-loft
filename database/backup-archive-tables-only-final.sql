-- =====================================================
-- BACKUP AND ARCHIVE SYSTEM - TABLES ONLY (FINAL)
-- =====================================================
-- This script creates only the essential tables without any configuration
...
-- Success message
SELECT 'Backup and Archive system tables created successfully! Configuration can be added manually later.' as result;