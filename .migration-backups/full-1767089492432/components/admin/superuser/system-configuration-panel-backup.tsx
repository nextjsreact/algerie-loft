    ...
    <div className="space-y-6">
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  {config.previous_value && (
                    <div className="mt-2">
                      ...
                      <div className="text-xs text-muted-foreground mt-1">
                        {t('modifiedBy')} {config.previous_modified_by} {t('on')}{' '}
                  ...
                  <div className="mt-2 text-xs text-muted-foreground">
                    {t('modifiedBy')} {config.modified_by} {t('on')} {new Date(config.modified_at).toLocaleString()}
                  </div>
                </div>
      ...
      <Dialog open={showCreateDialog} onOpenChange={setShowCreateDialog}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            <DialogTitle>{t('newConfiguration')}</DialogTitle>
            <DialogDescription>
              {t('addNewConfig')}
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <Label htmlFor="config_key">{t('configKey')}</Label>
              <Input
                id="config_key"
                value={formData.config_key}
                onChange={(e) => setFormData(prev => ({ ...prev, config_key: e.target.value }))}
                placeholder={t('placeholders.configKey')}
              />
            </div>
            
            <div>
              <Label htmlFor="data_type">{t('dataType')}</Label>
              <Select 
            ...
            <div>
              ...
              {formData.data_type === 'json' ? (
                ...
                <Input
                  ...
                  onChange={(e) => setFormData(prev => ({ ...prev, config_value: e.target.value }))}
                  placeholder={
                    formData.data_type === 'boolean' ? t('placeholders.booleanValue') :
                    formData.data_type === 'number' ? t('placeholders.numberValue') : 
            ...
            <div className="flex items-center space-x-2">
              ...
              />
              <Label htmlFor="is_sensitive">{t('isSensitive')}</Label>
            </div>
            ...
            <div className="flex items-center space-x-2">
              ...
              />
              <Label htmlFor="requires_restart">{t('requiresRestart')}</Label>
            </div>
          </div>
        ...
        <Dialog open={!!editingConfig} onOpenChange={() => setEditingConfig(null)}>
          <DialogContent className="max-w-2xl">
            <DialogHeader>
              ...
              <DialogDescription>
                {t('editingConfig')} {editingConfig.config_key}
              </DialogDescription>
            </DialogHeader>
            
            <div className="space-y-4">
              <div>
                <Label htmlFor="edit_value">{t('newValue')}</Label>
