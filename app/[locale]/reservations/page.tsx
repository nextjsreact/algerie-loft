                  ...
                  {selectedReservation.guest_phone && (
                    <Button
                      ...
                      onClick={async () => {
                        ...
                        const lines = [
                          guestName ? `Bonjour ${guestName} \u{1F44B}` : 'Bonjour \u{1F44B}',
                          '',
                          '\u2705 Votre r\u00e9servation est confirm\u00e9e !',
                          '',
                          `\u{1F3E0} Appartement : ${loftName}`,
                          `\u{1F4CD} Adresse : ${address}`,
                          gps ? `\u{1F5FA}\uFE0F GPS : ${gps}` : '',
                          `\u{1F4C5} Arriv\u00e9e : ${res.check_in_date} \u00e0 partir de ${checkInTime}`,
                          `\u{1F4C5} D\u00e9part : ${res.check_out_date}`,
                          `\u{1F319} Dur\u00e9e : ${nights} nuit${nights > 1 ? 's' : ''}`,
                          `\u{1F465} Nombre de personnes : ${res.guest_count || 1}`,
